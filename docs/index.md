...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Cms</span>
    </h1>
    <p class="hero-subtitle">Modern headless CMS with enterprise features and API-first architecture</p>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-cms" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
- **🎯 Headless Architecture**: Advanced headless architecture capabilities
- **🎯 Modern UI**: Advanced modern ui capabilities
- **🎯 Enterprise Features**: Advanced enterprise features capabilities
- **🎯 Developer Friendly**: Advanced developer friendly capabilities
...
### 🔧 Technology Stack
**React, Node.js, GraphQL, PostgreSQL, Redis, Docker**
...
# Run container
docker run -p 8080:8080 tiation-cms
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-cms)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-cms/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-cms/discussions)
...
- **Content Management**: Professional implementation
- **API Development**: Professional implementation
- **Multi-Channel Publishing**: Professional implementation
